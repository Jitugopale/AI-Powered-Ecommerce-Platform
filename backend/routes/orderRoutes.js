...
import { adminGetAllOrdersController, checkoutController, getMyOrderByIdController, getMyOrdersController, verifyPaymentController } from "../controllers/orderController.js";
...
orderRouter.get('/admin/all-orders',roleMiddleware("ADMIN"),adminGetAllOrdersController)
